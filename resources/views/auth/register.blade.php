    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{role_id: 2}">
            ...
            <div class="mt-4" x-show="role_id == 2">
                ...
                <x-jet-input id="nama_perusahaan" class="block mt-1 w-full" type="text" :value="old('nama_perusahaan')" name="nama_perusahaan" />
            </div>

            <div class="mt-4" x-show="role_id == 2">
                <x-jet-label for="detail" value="{{ __('Detail Perusahaan') }}" />
                <x-jet-input id="detail" class="block mt-1 w-full" type="text" :value="old('detail')" name="detail" />
            </div>
