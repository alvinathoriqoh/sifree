                            ...
                            <tr>
                             ...
                             <td>
                                ...
                                {{-- <a href="#" onclick="return confirm('yakin hapus?')" class="btn btn-icon btn-danger"><i class="fas fa-times"></i>
                                    ...
                                    <a class="btn btn-icon btn-dark" href="{{ url('/proyek/edit/' . encrypt($data->id_proyek)) }}"><i class="far fa-file"></i></a>
                                    <a class="btn btn-icon btn-danger" onclick="return confirm('anda yakin menghapus {{ $data->judul }}')" href="{{ url('/proyek/delete/' . encrypt($data->id_proyek)) }}"><i class="fas fa-times"></i></a>
