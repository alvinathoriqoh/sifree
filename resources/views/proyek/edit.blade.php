          ...
          @endif
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label>Judul</label>
                <input type="text" class="form-control" name="judul" value="{{ $proyek->judul }}">
              </div>
              <div class="form-group">
                <label>Jenis</label>
                <select class="form-control" name="jenis" value="{{ $proyek->jenis }}">
              ...
              <div class="form-group">
                <label>File</label>
                <input type="file" class="form-control" name="file" value="{{ $proyek->file }}">
              </div>
              <div class="form-group">
                <label>Detail</label>
                <input type="text" class="form-control" name="detail" value="{{ $proyek->detail }}">
              </div>
              {{-- <div class="form-group">
                <label>Detail</label>
              ...
              <div class="form-group">
                ...
                <input type="date" class="form-control" name="tgl_mulai" value="{{ $proyek->tgl_mulai }}">
              </div>
              <div class="form-group">
                <label>Tanggal Selesai</label>
                <input type="date" class="form-control" name="tgl_selesai" value="{{ $proyek->tgl_selesai }}">
              </div>
